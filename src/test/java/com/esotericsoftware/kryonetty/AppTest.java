    ...
    public void testApp() throws InterruptedException, SSLException, CertificateException {
        ...
        server.addListener(new Listener() {
            ...
            public void received(ChannelHandlerContext ctx, Object object) {
                ...
                ctx.getChannel().write(new AppTest("Did you know that our communication is secured via" + ctx.getPipeline().get(SslHandler.class).getEngine().getSession().getCipherSuite() + "?"));
        ...
        client.addListener(new Listener() {
            ...
            public void received(ChannelHandlerContext ctx, Object object) {
                assertTrue(object instanceof AppTest);
                assertTrue(((AppTest) object).data.contains("Hello Client!")|| ((AppTest) object).data.contains("communication"));
                System.out.println(object);
            }
        });
